...
btns[0].addEventListener('click', () => {
    // if (!btns[1].classList.contains('red')) { // Если у Второй кнопки нет класса РЕД, то при нажатии на Первую мы его тоглим
...
// wrapper.append(btn); // append позволит поместить новую btn в родительский класс wrapper
